# Installing Matt Pocock's skills for OpenCode
...
```json
{
  "plugin": ["zademy-skills@git+https://github.com/zademy/skills.git#v1.2.3"]
}
```
...
1. Check logs: `opencode run --print-logs "hello" 2>&1 | grep -i mattpocock`
